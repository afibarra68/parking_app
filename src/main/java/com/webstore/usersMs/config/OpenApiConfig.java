...
/**
 * Configuración de OpenAPI (Swagger) para documentar todos los servicios REST.
 */
@Configuration
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info()
                        ...
                        .version("1.0.0")
                        .description("API REST para la gestión de usuarios, empresas, transacciones, tarifas y configuración del sistema de parqueadero")
                        .contact(new Contact()
