...
@Repository
public interface ClosedTransactionRepository
              extends JpaRepository<ClosedTransaction, Long>, JpaSpecificationExecutor<ClosedTransaction> {
       ...
       @Query(value = "SELECT COUNT(*) FROM closed_transaction ct " +
                     ...
                     "AND ct.operation_date < CAST(CURRENT_DATE + INTERVAL '1 day' AS TIMESTAMP)", nativeQuery = true)
